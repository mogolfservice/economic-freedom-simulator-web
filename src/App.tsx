...
function App() {
  ...
  const localizedName = (id: string, fallback: string) => {
    const names = {
      ko: { cash: '현금/예금', stock: 'ETF/주식', irp: 'IRP/퇴직연금', home: '거주 부동산', mortgage: '주택담보대출', 'national-pension': '국민연금' },
      en: { cash: 'Cash/deposits', stock: 'ETFs/stocks', irp: 'IRP/retirement pension', home: 'Primary residence', mortgage: 'Mortgage', 'national-pension': 'National pension' },
      ja: { cash: '現金/預金', stock: 'ETF/株式', irp: 'IRP/退職年金', home: '居住用不動産', mortgage: '住宅ローン', 'national-pension': '国民年金' },
    } as const
